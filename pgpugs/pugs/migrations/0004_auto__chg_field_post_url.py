...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('pugs_post', 'url', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'Post.url'
        raise RuntimeError("Cannot reverse this migration. 'Post.url' and its values cannot be restored.")
